...
const BillingSystem = () => {
  ...
  const handleCartDataChange = (index, field, value) => {
    ...
    if (field === 'qty') {
      ...
      // স্টকের সাথে পুনরায় ক্রস ভ্যালিডেশন
      ...
      updatedCart[index].unit_price = parseFloat(value) || 0; // ম্যানুয়াল প্রাইস অ্যাসাইন

    }



    // প্রতি রো-এর ইন্ডিভিজুয়াল টোটাল রি-ক্যালকুলেশন
  ...
  const handleGenerateChallan = async () => {
    ...
    try {
      ...
      for (let item of cart) {
        ...
        // 💾 ফিক্স: ডাটাবেজে আপনার ম্যানুয়ালি এডিট করা unit_price এবং total পাঠানো হচ্ছে
                ...
                <tbody className="divide-y divide-slate-100">
                  ...
                  {cart.map((item, idx) => (
                    ...
                    <tr key={idx} className="hover:bg-slate-50 transition-colors">
                      ...
                      {/* 🛠️ লাইভ ম্যানুয়াল প্রাইস এন্ট্রি ইনপুট বক্স */}
