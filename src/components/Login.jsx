...
const Login = ({ onLoginSuccess }) => {
  ...
  const handleSendOtp = async (e) => {
    ...
    try {
      ...
      // নেটওয়ার্ক সমস্যার কারণে অনেক সময় রেসপন্স আসার আগেই কানেকশন ক্লোজ হয়ে যায়, কিন্তু ওটিপি মেইল চলে যায়।
      alert("ত্রুটি: " + err.message + "\n\nযদি আপনার ইমেইলে ইতিমধ্যেই কোড এসে থাকে, তবে নিচের বাটনে ক্লিক করে কোডটি প্রবেশ করান।");
      setOtpSent(true);
    }
    setLoading(false);
  };
